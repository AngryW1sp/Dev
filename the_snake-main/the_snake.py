...
class Apple(GameObject):
    ...
    def randomize_position(self):
        return (randint(0, SCREEN_WIDTH // 20 - 1) * GRID_SIZE, randint(0, SCREEN_HEIGHT // 20 - 1) * GRID_SIZE)
...
class Snake(GameObject):
    ...
    def move(self):
        new_position = ((self.positions[0][0] + self.direction[0] * GRID_SIZE) % SCREEN_WIDTH,
